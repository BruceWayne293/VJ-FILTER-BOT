...
PICS = (environ.get('PICS', 'https://graph.org/file/272f774a3d698123573ce.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8293838 683443719').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', 'AUTH_CHANNEL').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002019841747').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002019841747') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002019841747')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "moviezone12390")
...
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'LinkCents.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'bdd6d346a92b774af1bd8a6727a9cbbde725c801')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownloadlink_mz/53') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
